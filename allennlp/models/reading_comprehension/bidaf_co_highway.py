...
class BidirectionalAttentionFlow_co_highway(Model):
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(BidirectionalAttentionFlow_co_highway, self).__init__(vocab, regularizer)
        ...
        self._atten_highway_layer = TimeDistributed(Highway(phrase_layer.get_output_dim()*4,
                                                      num_highway_layers))
