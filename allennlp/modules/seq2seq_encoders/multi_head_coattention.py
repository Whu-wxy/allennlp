...
@Seq2SeqEncoder.register("multi_head_coattention")
class MultiHeadCoAttention(Seq2SeqEncoder):
    ...
    def __init__(self,
        ...
        # self._output_projection = Linear(input_dim, self._output_dim)
    ...
    def forward(self,  # pylint: disable=arguments-differ
        ...
        # # shape (batch_size, passage_length, input_size)
        # passage_passage_vectors = self._output_projection(passage_passage_vectors)

        return passage_question_vectors, passage_passage_vectors
