...
class MultiHeadCoAttention42(Seq2SeqEncoder):
    ...
    def __init__(self,
        ...
        super(MultiHeadCoAttention42, self).__init__()

        self._num_heads = num_heads
        self._input_dim = input_dim
        self._output_dim = input_dim

        self._coattention_blocks: List[MultiHeadCoAttention_block42] = []
        for block_index in range(num_blocks):
            coattention_block = MultiHeadCoAttention_block42(num_heads,
                                                             input_dim,
...
@Seq2SeqEncoder.register("multi_head_coattention_block42")
class MultiHeadCoAttention_block42(Seq2SeqEncoder):
    # pylint: disable=line-too-long
    """
    This class implements the key-value scaled dot product attention mechanism
    detailed in the paper `Attention is all you Need
